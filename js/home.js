...
function draw() {
  ...
  for (const b of balls) {
    ...
    // screen edge bounces
    if (b.x - b.r < 0)      { b.x = b.r;         b.vx =  abs(b.vx) * HOME.bounce; }
    if (b.x + b.r > width)  { b.x = width - b.r;  b.vx = -abs(b.vx) * HOME.bounce; }
    if (b.y - b.r < 0)      { b.y = b.r;           b.vy =  abs(b.vy) * HOME.bounce; }
    if (b.y + b.r > height) { b.y = height - b.r;  b.vy = -abs(b.vy) * HOME.bounce; }
